...
export const products: Product[] = [
  ...
  // ── SOCIAL MEDIA DETOX ──
  {
    id: 'p10', slug: 'social-media-detox', category: 'goals', price: 9.99, prices: { USD: 9.99, INR: 399 }, dodoProductIds: { USD: 'pdt_0NjngaC7iuVS9esTr9tGY', INR: 'pdt_0NkQ9uAZEo8fkWfP1TdxI' }, previewType: 'workbook', icon: '📵', ogImage: '/og-social-media-detox.png',
